...
smoothie_ecg1.addTimeSeries(ecg1, { strokeStyle:'rgb(0, 255, 0)', fillStyle:'rgba(0, 255, 0, 0.4)', lineWidth:3 });
smoothie_ecg2.addTimeSeries(ecg2, { strokeStyle:'rgb(255, 0, 255)', fillStyle:'rgba(255, 0, 255, 0.4)', lineWidth:3 });

$(document).ready(function(){
    var ws = new MozWebSocket($('body').attr('data-web-socket'));
